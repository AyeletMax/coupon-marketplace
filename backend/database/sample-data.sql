...
('admin', '$2b$12$p61JVdKaQq004/GgY9kFrOwGVYwDV5w1nP4bB.fk8Rcm/vSJsg6Zu')
...
('11111111-1111-1111-1111-111111111111', 50.00, 20.00, 'STRING', 'PIZZA-XYZ-12345');
...
INSERT INTO coupons (product_id, cost_price, margin_percentage, value_type, value) VALUES
('22222222-2222-2222-2222-222222222222', 200.00, 15.00, 'STRING', 'SPA-ABC-67890');
...
INSERT INTO coupons (product_id, cost_price, margin_percentage, value_type, value) VALUES
('33333333-3333-3333-3333-333333333333', 80.00, 25.00, 'STRING', 'CINEMA-QWE-99999');
...
INSERT INTO coupons (product_id, cost_price, margin_percentage, value_type, value) VALUES
('44444444-4444-4444-4444-444444444444', 300.00, 30.00, 'STRING', 'RESTO-ZXC-11111');
...
INSERT INTO coupons (product_id, cost_price, margin_percentage, value_type, value) VALUES
('55555555-5555-5555-5555-555555555555', 400.00, 20.00, 'STRING', 'GYM-FIT-55555');
